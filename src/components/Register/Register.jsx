...
//                                     <FaUser className="absolute top-1/2 left-3 transform -translate-y-1/2 h-6 text-amber-200"></FaUser>
//                                 </div>
...
//                                     <FaLink className="absolute top-1/2 left-3 transform -translate-y-1/2 h-6 text-amber-200"></FaLink>
//                                 </div>
...
//                                     <span onClick={() => setShowPass(!showPass)} className="absolute top-7 right-3 transform -translate-y-1/2 h-6 text-xl text-amber-200">
//                                         {
